{
  ...
  let kwd_tbl = ["and",AND; "def",DEF; "for",FOR; "if",IF; "else",ELSE; "while",WHILE; "True",TRUE;"False",FALSE;
                 "in",IN;"not",NOT; "or",OR ;"return",RETURN; "None",NONE ; "break",BREAK; "continue",CONTINUE;
                 "yield",YIELD]
